...
public class Detalles extends javax.swing.JFrame {
    ...
    public void setPartido(Partido partido){
        p = partido;
        jTextField1.setText(p.getDeporte().getNombre());
        jTextField2.setText(p.getLugar());
        jTextField3.setText(p.getFecha().getTime().toString());
        jTextArea1.setText(p.getComentarios());
    }
    
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        try{
            OrganizadorPartidos.getInstance().cancelarJugador(OrganizadorPartidos.getInstance().getLogeado(), p);
            JOptionPane.showMessageDialog(this, "Borrado del partido", "Borrado", JOptionPane.INFORMATION_MESSAGE);
